...
import { getProjectsByEmail, getDocumentsByEmail, type ProjectRecord, type DocumentRecord } from "./projects-documents";
...
export async function getAllProjects(): Promise<(ProjectRecord & { clientName: string })[]> {
...
export async function getAllDocuments(): Promise<(DocumentRecord & { clientName: string })[]> {
...
export async function getAllInvoices(): Promise<(InvoiceRecord & { clientName: string })[]> {
